...
'''Translation: [0.963, 0.153, 0.688]
- Rotation: in Quaternion [-0.066, 0.676, -0.092, 0.728]
            in RPY (radian) [-1.232, 1.334, -1.269]
            in RPY (degree) [-70.572, 76.433, -72.692]'''
...
def main():
    ...
    try:
        ...
        if (args.position is None and args.orientation is None
            ...
            pose.position.x,pose.position.y, pose.position.z = 0.653, 0.390, -0.167
            pose.orientation.x, pose.orientation.y, pose.orientation.w, pose.orientation.z = -0.366, 0.926, 0.030, 0.087
